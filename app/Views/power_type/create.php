...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Jenis Daya Baru</h6>
    </div>
    <div class="card-body">
        <?php if (isset($errors)): ?>
        ...
        <form action="<?= base_url('/power-types/store') ?>" method="post">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="name" class="form-label">Nama Jenis Daya <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="name" name="name" value="<?= old('name') ?>" required>
                        <div class="form-text">Contoh: Listrik, Baterai, Solar, dll</div>
                    </div>
                </div>
            </div>
